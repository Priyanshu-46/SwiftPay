...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<PaymentDtos.ErrorResponse> handleMissingHeader(
    ...
    public ResponseEntity<PaymentDtos.ErrorResponse> handleDuplicate(
        ...
        log.info("Duplicate payment request: {}", ex.getMessage());
    ...
    private PaymentDtos.ErrorResponse buildError(
            String code,
            String message,
            WebRequest request) {
